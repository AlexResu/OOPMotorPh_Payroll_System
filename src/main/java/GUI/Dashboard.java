...
public class Dashboard extends javax.swing.JPanel {
    ...
    private void setDashboardInfo(){
        if(user instanceof HRPersonnel){
            List<Integer> dashboardInfo = ((HRPersonnel) user).loadDashboard();
            jLabel3.setText(Integer.toString(dashboardInfo.get(0)));
            jLabel9.setText("+" + Integer.toString(dashboardInfo.get(1)));
            
        } else {
            List<Integer> dashboardInfo = ((SystemAdministrator) user).loadDashboard();
            jLabel3.setText(Integer.toString(dashboardInfo.get(0)));
            jLabel9.setText("+" + Integer.toString(dashboardInfo.get(1)));
    ...
    protected void loadEmployeeList(){
        if (user instanceof HRPersonnel) {
            newUsers = ((HRPersonnel) user).loadNewEmployees();
        } else {
            newUsers = ((SystemAdministrator) user).loadNewUsers();
        }
