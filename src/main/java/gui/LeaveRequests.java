...
public class LeaveRequests extends javax.swing.JPanel {
    ...
    for (LeaveRequest leave : leaves) {
        ...
        if (leave.getLeaveStatus().equalsIgnoreCase("PENDING")) {
            pendingCount++;
        } else if (leave.getLeaveStatus().equalsIgnoreCase("APPROVED")) {
            approvedCount++;
        } else if (leave.getLeaveStatus().equalsIgnoreCase("DECLINED")) {
            declinedCount++;
        }
    }

    // Set the count summary to labels
    pendinglabel.setText("Pending: " + pendingCount);
    approvedlabel.setText("Approved: " + approvedCount);
    deniedlabel.setText("Declined: " + declinedCount);
}
    ...
    private void initComponents() {
        ...
        deniedlabel = new javax.swing.JLabel();
        ...
        add(approve, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 90, 90, 40));
        ...
        decline.setMaximumSize(new java.awt.Dimension(48, 16));
        decline.setMinimumSize(new java.awt.Dimension(48, 16));
        decline.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                declineActionPerformed(evt);
            }
        });
        add(decline, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 90, 90, 40));
        ...
        deniedlabel.setText("Denied:");
        add(deniedlabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 100, -1, -1));

        pendinglabel.setText("Pending:");
        add(pendinglabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 100, -1, -1));

        approvedlabel.setText("Approved:");
        add(approvedlabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 100, -1, -1));
    }// </editor-fold>                        
    ...
    private void declineActionPerformed(java.awt.event.ActionEvent evt) {                                        
        jLabel3.setVisible(true);
        SwingWorker<Boolean, Void> worker = new SwingWorker<Boolean, Void>() {
            @Override
            protected Boolean doInBackground() throws Exception {
    ...
    private void leaveRemarksActionPerformed(java.awt.event.ActionEvent evt) {                                             
        loadLeavesList();
    }                                            

    private void jScrollPane9MouseWheelMoved(java.awt.event.MouseWheelEvent evt) {                                             
    ...
    private javax.swing.JLabel deniedlabel;
